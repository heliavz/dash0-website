...
const actions = [
  ...
  },
  {
    ...
    scenario:
      "A developer wonders why checkout latency keeps spiking. The Threadweaver stitches together the full journey across services, highlighting where the slowdown begins — a downstream dependency introduced in the last deploy.",
  ...
  },
  {
    ...
    scenario:
      'A developer asks Agent0 to "Create a dashboard and alerts for my ProductCatalog service." The Artist analyzes existing telemetry, then generates a clean, best-practice dashboard with latency, error rate, and throughput — complete with alert rules.',
